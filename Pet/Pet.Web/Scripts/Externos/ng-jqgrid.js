                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.$watch('config', function (value) {
                        ...
                        scope.getColumnasDeControl_aux = function (idgrilla, objformulario, tipoDatos) {
                            ...
                            $(objformulario.Parts.Secciones).each(function (x) {
                                //$(objformulario.Parts.Secciones[x].Parts.Controls).each(function (y) {
                                    mcontrols.push(objformulario.Parts.Secciones[x]);
                            ...
                            $.each(objColumnasBackOffice, function (x) {
                                ...
                                var cantidadCaracteres = objColumnasBackOffice[x].Parts.CantidadCaracteres;
                                var nombreFuncionHiperlink = objColumnasBackOffice[x].Parts.FuncionHiperlink;
                                var urlHiperlink = objColumnasBackOffice[x].Parts.UrlHiperlink;
                                ...
                                if (strCtrEditable == "1") {
                                    ...
                                    if (tipoformato == "Hiperlink") {

                                        objformater = function (cellvalue, options, rowObject) {
                                            return scope.$parent.MiUrl(attrs.idgrilla, options.colModel.name, cellvalue, options, rowObject, nombreFuncionHiperlink, urlHiperlink);
                                        };
                                    }
                            ...
                            if (objGrilla.multiselect != "1") {
                                objGrilla.multiselect = "";
                            }
                            else {
                                if (scope.$root.DatosFormulario.HideColumnCheck != undefined) {
                                    if (scope.$root.DatosFormulario.HideColumnCheck == "1") {
                                        objGrilla.multiselect = "";
                                    }
                                }
                            ...
                            var camposJqGrid = {
                                ...
                                multiselect: objGrilla.multiselect
                            };
                            return camposJqGrid;
                        ...
                        scope.GetAtributosGrid = function () {
                            ...
                            if (objColumnasDeControl.multiselect != "1") {
                                objColumnasDeControl.multiselect = "";
                            }
                            else {
                                if (scope.$root.DatosFormulario.HideColumnCheck != undefined) {
                                    if (scope.$root.DatosFormulario.HideColumnCheck == "1") {
                            ...
                            var paramjqGrid = {
                                ...
                                multiselect: objColumnasDeControl.multiselect,
                                ...
                                onSelectRow: function (rowid, iRow, iCol, e) {
                                    ...
                                    try {
                                        if (attrs.idgrilla == "084671D6-CB2C-441F-AC7F-9969B7019FBA" || attrs.idgrilla == "C3BE6E5E-EDD1-46D5-9531-5BD49F94A690"
                                            || attrs.idgrilla == "54C6E62F-0681-45D9-A353-7280E2236363"
                                            || attrs.idgrilla == "02E85E41-08DD-4030-BB4F-63BECB976D69") {
                                            scope.$parent.GrillaClick(this, attrs.idgrilla, rowid, iRow, iCol, e);
                                        }
                                        else {
                                            if (scope.$parent.onSelectRow) {
                                                scope.$parent.onSelectRow(this, attrs.idgrilla, rowid, iRow, iCol, e);
                                            }
                                        };
                                ...
                                onSelectAll: function (rowIds, status) {
                                    if (scope.$parent.onSelectAll) {
                                        scope.$parent.onSelectAll(this, attrs.idgrilla, rowIds, status);
                                    }
                                },
                                ...
                                gridComplete: function () {
                                    ...
                                    var CountCheck = 0;
                                    if (attrs.idgrilla.toUpperCase() == "18B0EDD8-1287-4ED9-84BF-4FFC9FBFFCC7") {
                                        var lista = $rootScope.DatosFormulario.ListaCheck;
                                        if (lista != undefined) {
                                            var filtroLista = lista;
                                            if (Object.keys(filtroLista).length > 0) {
                                                var rowIds = $('#' + attrs.gridid).jqGrid('getDataIDs');
                                                for (var indice in filtroLista) {
                                                    for (var p = 0; p < rowIds.length; p++) {
                                                        var row = $('#' + attrs.gridid).jqGrid('getRowData', rowIds[p]);
                                                        if (row.CodigoContenedor == filtroLista[indice].CodigoContenedor) {
                                                            $('#' + attrs.gridid).jqGrid('setSelection', rowIds[p], false);
                                                            CountCheck++;
                                                            break;
                                                        }
                                                    }
                                                }
                                                if (CountCheck == rowIds.length) {
                                                    var checkboxAll = $("#cb_" + attrs.gridid).prop("checked", true);
